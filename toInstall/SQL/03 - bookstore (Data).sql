...
--
-- Serveur: localhost
-- Généré le : Jeu 16 Décembre 2021 à 19:18
...
INSERT INTO `account` (`account_id`, `login`, `password`, `email`, `role`, `token`, `status`) VALUES
...
SET FOREIGN_KEY_CHECKS=0;
INSERT INTO `order` (`order_id`, `Order_TotalAmount`, `current_status`, `shipping_address`, `billing_address`, `user_id`) VALUES
...
--
-- Contenu de la table `order_book`
--

SET FOREIGN_KEY_CHECKS=0;
INSERT INTO `order_book` (`order_book_id`, `qty`, `amounts`, `book_id`, `order_id`) VALUES
(1, 1, 55.50, 2, 1),
(2, 10, 49.49, 7, 1),
(3, 2, 60.00, 1, 2),
(4, 3, 166.50, 2, 2),
...
SET FOREIGN_KEY_CHECKS=0;
INSERT INTO `order_history` (`order_history_id`, `status`, `date`, `order_id`) VALUES
(1, '0', '2021-12-07', 1),
(2, '1', '2021-12-08', 1),
(3, '2', '2021-12-09', 1),
(4, '0', '2021-12-13', 2),
...
SET FOREIGN_KEY_CHECKS=0;
INSERT INTO `owner` (`owner_id`, `firstname`, `lastname`, `account_id`) VALUES
(1, 'Harry', 'Newman', 1),
(2, 'Bernard', 'Steve', 2);
...
SET FOREIGN_KEY_CHECKS=0;
INSERT INTO `publisher` (`publisher_id`, `name`, `email`, `phone_number`, `banking_account`, `address`) VALUES
...
--
-- Contenu de la table `shopping_cart`
--
...
SET FOREIGN_KEY_CHECKS=0;
INSERT INTO `user` (`user_id`, `firstname`, `middleInitial`, `lastname`, `Phone1`, `Phone2`, `credit_card_name`, `credit_card_number`, `credit_card_security_code`, `credit_card_expiry_date`, `account_id`) VALUES
...
SET FOREIGN_KEY_CHECKS=0;
INSERT INTO `user_address` (`address_id`, `streetnumber`, `streetname`, `apart_num`, `city`, `state`, `zip`, `user_id`) VALUES
